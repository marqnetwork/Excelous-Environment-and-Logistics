    ...
    <div className="bg-cream min-h-screen text-dark">
      ...
      <section className="py-40 bg-cream/30">
        <div className="max-w-7xl mx-auto px-6 text-center mb-32">
          <h2 className="text-4xl md:text-6xl font-serif text-dark italic">The Pillars of </b> <span className="text-accent not-italic">Excelous Environmental & Logistics.</span></h2>
